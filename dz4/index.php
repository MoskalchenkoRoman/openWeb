...
$work_experience = [
    [
        'name' => 'Лесоруб',
        'accepted' => '01.01.2010',
        'dismissed' => 'по сей день',
        'duties' => 'рубить лес',
    ],
    [
        'name' => 'Копатель',
        'accepted' => '01.01.2009',
        'dismissed' => '31.12.2009',
        'duties' => 'копать и не копать',
    ],
    [
        'name' => 'Водохлеб',
        'accepted' => '01.01.2006',
        'dismissed' => '30.12.2009',
        'duties' => 'дегустация воды',
    ]
]
?>
<!DOCTYPE html>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience[$i]['accepted'] ?> - 
          <?php if($i == 0): ?>
            <span class="w3-tag w3-teal w3-round"><?php echo $work_experience[$i]['dismissed'] ?></span>
          <?php else: ?>
            <?php echo $work_experience[$i]['dismissed'] ?>
          <?php endif; ?>
          </h6>
          <p><?php echo $work_experience[$i]['duties'] ?></p>
          <hr>
          <?php endfor; ?>
        </div>
      </div>
